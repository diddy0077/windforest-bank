...
const CalculatorIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M9 7h6m0 10v3m0-3v-4m0 4h3m-3-4H9m0 0V9m0 4v3m0-3h3m-3-4V7a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 01-2 2h-8a2 2 0 01-2-2V7z"
    ></path>
  </svg>
);
const MoneyIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 012-2h2m0 0l-3-3m3 3l-3 3"
    ></path>
  </svg>
);
const GraduationIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M12 14l9-5-9-5-9 5 9 5zm0 10V18m0-4V10"
    ></path>
  </svg>
);
const CarIcon = () => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M16 8V6a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"
    ></path>
...
const LoanCalculator = ({ selectedLoan, setIsOpen, setConfirm }) => {
  ...
  if (!selectedLoan)
    return <p className="text-gray-500">Select a loan to calculate.</p>;
    ...
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl border-t-4 border-gray-800">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 text-center bg-red-50 p-4 rounded-lg">
        ...
        <p className="text-xs text-gray-500 mt-2">
          *Estimate based on {years} years and a ${amount.toLocaleString()}{" "}
          principal.
        </p>
      </div>
...
const LoanProductsPage = () => {
  ...
  useEffect(() => {
    if (location.state?.pendingLoan && LOAN_PRODUCTS.length > 0) {
      const match = LOAN_PRODUCTS.find(
        (l) => l.id === location.state.pendingLoan.loanId
      );
      if (match) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans antialiased">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-10 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <h2 className="text-3xl font-bold text-gray-800 border-b border-red-600 pb-3">
              Loan Products
            </h2>
          ...
          <aside className="lg:col-span-1">
            <h2 className="text-3xl font-bold text-gray-800 border-b border-red-600 pb-3 mb-8 hidden lg:block">
              Calculator
            </h2>
            <LoanCalculator
      ...
      {/* Footer CTA */}
      <div className="bg-gray-800 text-white py-12 mt-12 border-b border-gray-500">
        <div className="max-w-7xl mx-auto text-center px-6">
          <h3 className="text-3xl font-bold mb-3">Ready to Apply?</h3>
          <p className="text-gray-300 mb-6">
            Start your quick, secure online application today.
          </p>
          <Link
            to="/account-types"
            className="px-8 py-3 bg-red-600 text-white font-bold rounded-lg shadow-xl hover:bg-red-700 transition-colors"
          >
            Get Started
          </Link>
        </div>
