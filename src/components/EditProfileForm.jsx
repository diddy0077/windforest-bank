...
const EditProfileForm = ({ isOpen, setIsOpen,setNotifications }) => {
  ...
  type: 'success',
  message: "A change was made to your profile. If you didn't recognize this change, please contact customer support immediately!",
  ...
  return (
    <div className={`${isOpen ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'} flex justify-center items-center min-h-screen font-sans fixed h-screen inset-0 z-40 transition-all duration-300`}>
      <div
      ...
      <div className="w-full mx-4 max-w-lg bg-white rounded-3xl shadow-2xl p-8 z-50 max-h-[600px] overflow-y-auto relative">
        ...
        <svg className='fill-red-600 cursor-pointer' xmlns="http://www.w3.org/2000/svg" height="34px" viewBox="0 -960 960 960" width="34px"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>
      </button>
        {/* Header Section */}
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-4xl font-extrabold text-gray-800 text-center mb-1">Update Profile</h1>
          <p className="text-center text-gray-500 text-lg">Manage your personal and security information.</p>
        </div>
        
        <form onSubmit={saveChanges} className="space-y-8">
          {/* Personal Information Section */}
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b pb-2 border-gray-200">Personal Information</h2>
          ...
          {/* Security Section */}
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b pb-2 border-gray-200">Security</h2>
            <div className="space-y-6">
              {/* Password Input */}
              <div>
                <label htmlFor="password" className="block text-md font-semibold text-gray-900">Confirm your password to save changes.</label>
                <input
