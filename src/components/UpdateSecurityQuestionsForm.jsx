...
const UpdateSecurityQuestionsForm = ({openQuestion, setOpenQuestion,setNotifications}) => {
  ...
  type: 'success',
  message: "Your security question was updated. If you didn't recognize this change, please contact customer support immediately!",
  ...
  return (
    <div className={`${openQuestion ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'} flex justify-center items-center min-h-screen font-sans fixed h-screen inset-0 z-40 transition-all duration-300`}>
       <div
      ...
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-8 relative mx-4">
        <button onClick={() => setOpenQuestion(false)} className='absolute top-4 right-4'>
        <svg className='fill-red-600 cursor-pointer' xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>
      </button>
        {/* Header Section */}
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-gray-800 text-center mb-1">Update Security Questions</h1>
          <p className="text-center text-gray-500 text-lg">Help us keep your account secure by updating your questions.</p>
        </div>
